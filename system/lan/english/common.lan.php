...
$_L['Register_Voucher_Failed'] = 'Voucher Code Invalid';
$_L['Register_Success'] = 'Registration Successful! You can now login';
$_L['Sign_In_Member'] = 'Log in to Member Panel';
$_L['Register_Member'] = 'Register as Member';
$_L['Sign_In_Admin'] = 'Hotspot Administration Panel';
$_L['Logo'] = 'Martyless Networks';
$_L['Username'] = 'E-Mail / Username';
$_L['Password'] = 'Password';
$_L['PasswordsNotMatch'] = 'Passwords do not match';
$_L['account_already_exist'] = 'Account already exists';
$_L['Manage'] = 'Manage';
$_L['Submit'] = 'Submit';
...
$_L['Failed_Save_Page'] = "Failed to save page, probably due to write permissions";
$_L['Success_Save_Page'] = "Saving page success";
$_L['Info_Page'] = "Changes may take multiple refreshes to update";
...
$_L['BW_already_exist'] = 'Bandwidth Plan Name Already Exist';
...
$_L['Plan_already_exist'] = 'Name of Plan Already Exists';
...
$_L['user_type_help'] = 'Choose User Type - Sales disables access to Settings';
...
$_L['password_change_help'] = 'Keep blank if you do not wish to change your password';
$_L['currency_help'] = 'Keep  blank if you do not want to show the currency symbol';
...
$_L['Print_Info'] = 'Print side by side, it will easiser to cut';
...
$_L['Welcome_Text_Admin'] = 'Welcome';

//update
$_L['Invalid_Username_or_Password'] = 'Invalid Username or Password';
$_L['Do_Not_Access'] = 'You do not have the correct permissions to access this page';
$_L['Incorrect_Current_Password'] = 'Incorrect Current Password';
$_L['Password_Changed_Successfully'] = 'Password changed successfully, please login';
$_L['All_field_is_required'] = 'All fields are required';
$_L['Voucher_Not_Valid'] = 'Voucher Not Valid';
$_L['Activation_Vouchers_Successfully'] = 'Voucher Activation Successful!';
